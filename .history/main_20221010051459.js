...
function vehicles(){
  ...
  const numberplate = document.getElementById("service").value;
  const chasisnumber = document.getElementById("date").value;
  const model = document.getElementById("time").value;
  const user_id = 2;
  // const btn = document.getElementById("submit-btn").value;
